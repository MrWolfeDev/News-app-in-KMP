...
import n.composeapp.generated.resources.search
...
fun SearchBar(
    ...
    Box(
        ...
        val textFieldHeight = (deviceInfo.screenHeight * 0.03).dp
        val fontSize = (deviceInfo.screenWidth * 0.0090).sp
        ...
        Box {
            Box(
                modifier = Modifier
                    ...
                    .padding(
                        top = (deviceInfo.screenHeight * 0.10).dp,
                    ...
                    .fillMaxWidth()
                    .border(
                        width = (deviceInfo.screenWidth * 0.001).dp,
                        color = Color(deviceInfo.contentColor),
                        shape = RoundedCornerShape((deviceInfo.screenWidth * 0.005).dp)
                    )
